...
img = pygame.image.load("python-logo.png")
...
void main() {
	vec2 sample_pos = vec2(uvs.x + sin(uvs.y * 10 + time * 0.02) * 0.1, uvs.y);
...
while running:
	...
	frame_tex.release() # free up texture
